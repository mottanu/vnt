...
class AgentColectorController extends Controller
{
  
  /**
   * Matches /cms/ac/dashboard exactly
   *
   * @Route("/cms/ac/dashboard", name="acDashboard")
   * @Method({"GET"})
   *
   */
  public function acDashboard(Request $request) {
    
    $dm = $this->get('doctrine_mongodb')->getManager();
    $user = UtilsController::isValidSession($request, $dm);

    if(!$user || !$user->isAgentColector) {
    ...
    return $this->render('cms/ac/dashboard.html.twig', $params);
  }
