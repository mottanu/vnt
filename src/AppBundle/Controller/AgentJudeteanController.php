...
class AgentJudeteanController extends Controller
{
  
  /**
   * Matches /cms/aj/dashboard exactly
   *
   * @Route("/cms/aj/dashboard", name="ajDashboard")
   * @Method({"GET"})
   *
   */
  public function ajDashboard(Request $request) {
    
    $dm = $this->get('doctrine_mongodb')->getManager();
    $user = UtilsController::isValidSession($request, $dm);

    if(!$user || !$user->isAgentJudetean) {
    ...
    return $this->render('cms/aj/dashboard.html.twig', $params);
  }
